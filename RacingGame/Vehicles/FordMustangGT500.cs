/*
 *  This class represents the Mitsubishi Lancer Evo X vehicle and set the data appropriately for this car 
 */
using System;
...
{
    class FordMustangGT500 : Vehicle
    {
        //gear ratios and power levels
        private List<float> power = new List<float>(new float[] { 0.2f, 0.3f, 0.4f, 0.7f, 0.8f, 1.0f, 0.8f, 0.7f, 0.6f });
        private List<float> ratios = new List<float>(new float[] { -2.215f, 0, 2.625f, 1.750f, 1.322f, 1.096f, 0.961f });
        ...
        //collision sphere used for collision detection
        protected override BoundingSphere CreateBoundingSphere()
        {
            ...
            collisionSphere.Radius = collisionSphere.Radius / 420;
        ...
        {
            //frontWheelLeft.Transform *= Matrix.CreateTranslation(position) * Matrix.CreateRotationY(MathHelper.ToRadians(currentRotation));
