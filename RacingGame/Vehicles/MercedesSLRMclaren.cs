/*
 *  This class represents the Mercedes SLR Mclaren vehicle and set the data appropriately for this car 
 */
using System;
...
{
    class MercedesSLRMclaren : Vehicle
    {
        //gear ratios and power list
        List<float> power = new List<float>(new float[] { 0.4f, 0.5f, 0.6f, 0.7f, 0.8f, 1.0f, 0.8f, 0.7f, 0.6f });
        List<float> ratios = new List<float>(new float[] { -2.215f, 0, 3.2f, 2.19f, 1.65f, 1.2f, 0.82f });
        ...
        protected override BoundingSphere CreateBoundingSphere()
        {
            ...
            collisionSphere.Radius = collisionSphere.Radius / 14;
        ...
        {
            get { return "Mercedes Mclaren SLR"; }
        }
